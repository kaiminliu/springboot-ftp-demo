...
public class FtpUtil {
     ...
     * FTP服务器hostname
     */
    private static String HOST = "192.168.111.88";
    /**
     * FTP服务器端口
     */
     ...
     * FTP登录账号
     */
    private static String USERNAME = "ftp-file";
    /**
     * FTP登录密码
     */
    private static String PASSWORD = "liuyou";
    /**
     * FTP服务器基础目录
     */
    private static String BASEPATH = "/home/ftp-file";
    /**
     * FTP客户端
     */
        ...
        try {
            ...
            for (FTPFile ff : fs) {
                if (ff.getName().equals(fileName)) {
                    ...
                    ftp.retrieveFile(BASEPATH + remotePath+"/"+fileName,outputStream);
...
![](https://liuyou-images.oss-cn-hangzhou.aliyuncs.com/markdown/image-20210203161215304.png)

![](https://liuyou-images.oss-cn-hangzhou.aliyuncs.com/markdown/image-20210203161619676.png)

**下载**

![](https://liuyou-images.oss-cn-hangzhou.aliyuncs.com/markdown/image-20210203161732689.png)

![](https://liuyou-images.oss-cn-hangzhou.aliyuncs.com/markdown/image-20210203163027683.png)